...
-- AlterTable
ALTER TABLE "eventCategory" ADD COLUMN     "isActive" BOOLEAN NOT NULL DEFAULT false,
...
-- AlterTable
ALTER TABLE "eventQuestion" ALTER COLUMN "createdAt" SET DEFAULT CURRENT_TIMESTAMP;
...
-- AlterTable
ALTER TABLE "ticketGroupAnswer" ALTER COLUMN "createdAt" SET DEFAULT CURRENT_TIMESTAMP;
